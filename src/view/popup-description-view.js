  ...
  return `
    <div class="product-description">
      <div class="product-description__header">
        ...
        <b class="price price--size-big">${formatPrice(price)}<span>Р</span></b>
      </div>
...
export default class PopupDescriptionView extends AbstractStatefulView {
  ...
  shakeDeferButton = () => {
    ...
    if (!deferButtonElement) {
      return;
    }
    // this метода shake заменили на объект с "псевдо element"
    // Поэтому класс анимации добавится на deferButtonElement
