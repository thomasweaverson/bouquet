  ...
  <div class="catalogue__header">
    ...
    <div class="catalogue__sorting">
      <div class="sorting-price">
        ...
        <a class="sorting-price__link sorting-price__link--incr ${activeSortType === SortType.PRICE_INCREASE ? 'sorting-price__link--active' : ''}"
        ...
        <a class="sorting-price__link ${activeSortType === SortType.PRICE_DECREASE ? 'sorting-price__link--active' : ''}"
